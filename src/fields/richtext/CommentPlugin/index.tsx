...
export function CommentsPanel({
  ...
  return (
    <div className="CommentPlugin_CommentsPanel">
      <h2 className="CommentPlugin_CommentsPanel_Heading">{heading} <Close className='Close_Comments_Icon' onClick={() => setShowComments(false)} /></h2>
...
function useCollabAuthorName(): string {
  ...
  const userName = user?.completeName ?? 'Payload User';
