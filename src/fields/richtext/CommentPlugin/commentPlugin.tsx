...
import { Thread, Comment, CommentStore, useCommentStore } from './commenting'
import { AddCommentBox, CommentInputBox, CommentsPanel } from './index'
import {
  $createMarkNode,
  $getMarkIDs,
  $isMarkNode,
...
import { Comments } from '@/fields/richtext/CommentPlugin/commenting'

export const CommentPlugin: PluginComponent = () => {
  ...
  const commentStore: CommentStore = useMemo(() => new CommentStore(editor, initalComments), [editor])
